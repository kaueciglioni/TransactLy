...
using TransactLy.Web.Models.Enums;

namespace TransactLy.Web.Data
{
    public class SeedingService
    {
        public TransactLyContext _context;

        public SeedingService(TransactLyContext context)
        { 
            _context = context;
        }
        ...
        public void Seed()
        {
            if (_context.Department.Any() || _context.SalesRecord.Any() || _context.SalesRecord.Any())
            {
            ...
            Seller s8 = new Seller(8, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s9 = new Seller(9, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            ...
            SalesRecord r12 = new SalesRecord(12, new DateTime(2018, 09, 25), 7000.0, SaleStatus.Pending, s9);
            ...
            SalesRecord r27 = new SalesRecord(27, new DateTime(2018, 10, 13), 9000.0, SaleStatus.Pending, s7);
